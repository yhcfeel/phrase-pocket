...
import {validateExample} from '../app/review.js';
...
for(const entry of seed){if(entry.example)validateExample(entry.example);}
for(const file of ['index.html','app.js','offline.js','presentation.js','review.js','styles.css','phrases.json','manifest.webmanifest','icons/apple-touch-icon.png','icons/icon-192.png','icons/icon-512.png','icons/icon-maskable-512.png'])if(!files.includes(file))throw new Error('Missing: '+file);
